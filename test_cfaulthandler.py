# Note: test_cfaulthandler.py was forked from test_faulthandler.py in the
# builtin Python regression tests, and adapted to test cfaulthandler instead
# of the builtin faulthandler.
#
